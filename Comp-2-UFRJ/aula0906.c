 ...
 *
 * $Author: rafael.jesus $
 * $Date: 2021/10/13 01:03:56 $
 * $Log: aula0906.c,v $
 * Revision 1.2  2021/10/13 01:03:56  rafael.jesus
 * EEL270 - Computacao II - Turma 2021/1.
 * Correcao de erros.
 *
 * Revision 1.1  2021/10/12 19:46:30  rafael.jesus
 * Initial revision
 *
...
main (int argc, char *argv [ ])
{
    ...
    printf ("- Para mais informacoes de como usar o programa digite:\n");
		...
		switch (opcaoCurta)
    {
      ...
      case 'S':
        printf ("Opcao EXIBIR CONTEUDO DO ARQUIVO selecionada\n");
				...
				{
          printf ("Erro: Passando muitos argumentos atraves da linha de comando. \n");
					printf ("Uso: ./aula0905 -s | -S | --show <nome-arquivo>\n\n");
					exit (NUMERO_ARGUMENTOS_INVALIDO);
        }
      ...
      case 'H':
        ...
        printf ("- Para converter um arquivo de texto do formato Microsoft (DOS)");
				...
				printf ("./aula0905 -u | -U | --unix <nome-arquivo>");
				printf (" <nome-gerado-desejado(opcional)>\n\n");
